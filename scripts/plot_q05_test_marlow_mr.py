"""Overlay Q=0.5 test_marlow vs test_MR stress-strain curves."""
...
def main() -> int:
    ...
    ax.set_title("SFBLS Q=0.5 4×4×4 CAE C3D4 — Marlow vs Mooney-Rivlin (Hu & Bai TPU)")
    ax.grid(True, alpha=0.35)
    ax.legend(loc="upper left", fontsize=9)
    fig.tight_layout()

    out_dir = REPORTS_ROOT / "q05_test_marlow_mr"
    out_dir.mkdir(parents=True, exist_ok=True)
    png = out_dir / "q05_test_marlow_vs_MR.png"
