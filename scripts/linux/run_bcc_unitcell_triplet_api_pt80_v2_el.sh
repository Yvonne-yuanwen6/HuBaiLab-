#!/usr/bin/env bash
# BCC triplet A=pi mm^2, parallel-transport ellipse sweep, CAE C3D4, 80% strain.
#
#   bash scripts/linux/run_bcc_unitcell_triplet_api_pt80_v2_el.sh
set -euo pipefail
...
LOG="output/logs/bcc_unitcell_triplet_api_pt80_v2_el.log"
CAD_DIR="output/cad/triplet_unitcell_bcc_api_pt"
...
declare -a CASES=(
  "circular|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_circ_api_pt.step|cae_tet0p6mm80p_5mmin_uc_circ_api_pt_v2_el"
  "ellipse_minor|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_ellmin_api_pt.step|cae_tet0p6mm80p_5mmin_uc_ellmin_api_pt_v2_el"
  "ellipse_major|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_ellmaj_api_pt.step|cae_tet0p6mm80p_5mmin_uc_ellmaj_api_pt_v2_el"
)
...
log "=== BCC triplet A=pi parallel-transport 80% CAE start cpus=$CPUS mem=$MEM ==="

mkdir -p "$VERIFIED_DIR" "$CAD_DIR"
copy_map=(
  "${CAD_DIR}/hu_bai_bcc_unitcell_L20_d2x1.2_Api_pt_z_circular.step|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_circ_api_pt.step"
  "${CAD_DIR}/hu_bai_bcc_unitcell_L20_d2x1.2_Api_pt_z_ellipse_minor_align.step|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_ellmin_api_pt.step"
  "${CAD_DIR}/hu_bai_bcc_unitcell_L20_d2x1.2_Api_pt_z_ellipse_major_align.step|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_ellmaj_api_pt.step"
)
...
log "=== ALL THREE API_PT80 COMPLETE ==="
python3 scripts/plot_bcc_unitcell_triplet_v2_el.py --area-pi-pt \
  --write-json output/reports/bcc_unitcell_triplet/manifest_api_pt80.json \
