#!/usr/bin/env bash
# BCC unit-cell triplet: circular / ellipse-minor-Z / ellipse-major-Z
# V2 settings: elastic + contact-store-offsets, 70% strain, self-contact ON, no settle.
#
#   bash scripts/linux/run_bcc_unitcell_triplet_v2_el.sh
#   nohup bash scripts/linux/run_bcc_unitcell_triplet_v2_el.sh \
#     >> output/logs/bcc_unitcell_triplet_v2_el.log 2>&1 &
set -euo pipefail
...
LOG="output/logs/bcc_unitcell_triplet_v2_el.log"
CAD_DIR="output/cad/triplet_unitcell_bcc"
...
declare -a CASES=(
  "circular|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_circ.step|cae_tet0p6mm70p_5mmin_uc_circ_v2_el"
  "ellipse_minor|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_ellmin.step|cae_tet0p6mm70p_5mmin_uc_ellmin_v2_el"
  "ellipse_major|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_ellmaj.step|cae_tet0p6mm70p_5mmin_uc_ellmaj_v2_el"
)
...
log "=== BCC unitcell triplet V2 start cpus=$CPUS mem=$MEM ==="

mkdir -p "$VERIFIED_DIR"
copy_map=(
  "${CAD_DIR}/hu_bai_bcc_unitcell_L20_d2x1.2_z_circular.step|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_circ.step"
  "${CAD_DIR}/hu_bai_bcc_unitcell_L20_d2x1.2_z_ellipse_minor_align.step|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_ellmin.step"
  "${CAD_DIR}/hu_bai_bcc_unitcell_L20_d2x1.2_z_ellipse_major_align.step|${VERIFIED_DIR}/hu_bai_bcc_af0q0_L20_1x1x1_uc_ellmaj.step"
)
...
python3 scripts/plot_bcc_unitcell_triplet_v2_el.py \
  --write-json output/reports/bcc_unitcell_triplet/manifest.json \
