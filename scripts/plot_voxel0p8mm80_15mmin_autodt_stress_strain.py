"""
Plot four voxel0p8mm80_15mmin_autodt stress-strain curves on one figure.

  py -3 scripts/plot_voxel0p8mm80_15mmin_autodt_stress_strain.py
"""
...
_SUFFIX = "voxel0p8mm80_15mmin_autodt"
...
def plot_compare(
    ...
    *,
    ...
    ax.set_title("Hu & Bai 4x4x4 — voxel 0.8 mm, 80% strain @ 15 mm/min (automatic dt)")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Plot voxel0p8mm80 autodt comparison")
    parser.add_argument(
        "--png",
        default=str(REPORTS_ROOT / "voxel0p8mm80_15mmin_autodt_stress_strain_compare.png"),
    )
