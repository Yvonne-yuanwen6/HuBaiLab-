"""
Plot BCC Q=0 + SFBLS Q=0.5 paper_box CAE C3D4 stress-strain curves on one figure.
...
_CASES = (
    (f"hu_bai_bcc_af2q0_L20_4x4x4_solid_cad_f_{_SUFFIX}", "Q=0 (BCC, paper_box CAE C3D4)", "#89CFF0"),
    (
